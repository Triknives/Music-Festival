...
describe '#Stage' do
  ...
  describe('#save') do
    it('tests save function') do
      show = Stage.new(nil, "stage1", "Jason", "12/18/19", "13:00")
      show.save()
      show2 = Stage.new(nil, "stage2", "Jason", "12/18/19", "13:00")
      show2.save()
  ...
  describe('#==') do
    it('test stage time comparison') do
      show = Stage.new(nil, "stage1", "Jason", "12/18/19", "13:00")
      show.save()
      show2 = Stage.new(nil, "stage1", "Brett", "12/18/19", "13:00")
      show2.save()
  ...
  describe('.clear') do
    it('Able to clear all stages') do
      show = Stage.new(nil, "stage1", "Jason", "12/18/19", "13:00")
      show.save()
      show2 = Stage.new(nil, "stage2", "Brett", "12/18/19", "13:30")
      show2.save()
      Stage.clear()
      expect(Stage.all).to(eq([]))
    end
  ...
  describe('#update') do
    it('able to update stage information') do
      show = Stage.new(nil, "stage1", "Jason", "12/18/19", "13:00")
      show.save()
      show.update("stage2", "Brett", "12/18/19", "13:30")
